...
public class ModBlocks {
    ...
    public static final Block CADO_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).breakByHand(true).strength(0f, 10000f));


    public void registerAll(){
        register(TEST_BLOCK, new Identifier(Utils.MODID, "test_block"));
        register(BE_BLOCK, new Identifier(Utils.MODID, "be_block"));
        register(CADO_BLOCK, new Identifier(Utils.MODID, "cado_block"));
